  ...
  <div>
    ...
    <div class="bg-white w-full p-5 shadow rounded mb-5">
      ...
      <div class="flex items-center gap-5">
        <Popover title="Active">
          <router-link to="form" class="text-sm bg-black/10 text-gray-700 p-2 px-3 rounded">
            Form name
          </router-link>
        </Popover>
        <Popover title="Unactive">
          <router-link to="form" class="text-sm bg-black/10 text-gray-700 p-2 px-3 rounded">
            Form name
          </router-link>
        </Popover>
    ...
    <div class="bg-white w-full p-5 shadow rounded mb-5">
      ...
      <div class="flex items-center gap-5">
        ...
        <Popover title="Issue">
          <router-link to="form" class="text-sm bg-red-500 text-gray-700 p-2 px-3 rounded">
            #001234
          </router-link>
        </Popover>
        <Popover title="Deleted">
          <router-link to="form" class="text-sm bg-red-500/30 text-gray-700 p-2 px-3 rounded">
            #001234
          </router-link>
        </Popover>
        <Popover title="Closed">
          <router-link to="form" class="text-sm bg-black/10 text-gray-700 p-2 px-3 rounded">
            #001234
          </router-link>
        </Popover>
