...
<template>
  <div>
    <button
      class="relative flex items-center gap-2 p-1.5 px-4 rounded text-sm group"
      :class="
        design
          ? design
          : 'bg-blue-200/50 text-blue-500 hover:bg-blue-500 hover:text-white focus:bg-blue-500 focus:text-white '
      "
    >
